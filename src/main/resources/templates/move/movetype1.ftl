        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h2 class="display-5 animated fadeIn mb-4">가정이사</h2>
                    <p class="mb-4">
                        시작부터 끝까지 항상 고객입장에서 <span class="text-primary">안전함과 깨끗함을 지향하는 고객중심의 이사를 약속드립니다.</span>
                    </p>
                </div>
                <div class="col-md-6 animated fadeIn">
                    <img class="img-fluid" src="img/movetype1_l.jpg" alt="">
                </div>
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 700px;">
                    ...
                    <p>
                        이사는 단순 운송이 아닌 종합 서비스 입니다.
                        포장이사는 물품파손 방지를 위한 포장과 주부님의 편의를 최대한으로 하기위한 정리 서비스가 포인트 입니다.
                        저희 이사청소 한방은 회원사 서비스 교육을 통하여 팀장, 직원이 현장에서 고객님의 편의를 최대한으로 하기위한 최선의 노력을 다하고 있습니다.
                    </p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s" >
                        <a class="cat-item d-block bg-light text-center rounded p-1" href="" >
                            <div class="rounded p-2" style="height: 400px;">
                                <div class="icon mb-3">
