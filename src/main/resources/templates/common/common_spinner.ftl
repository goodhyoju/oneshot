    ...
    <div class="modal-dialog modal-dialog-centered modal-fullscreen" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="z-index: 1">
                <div class="col-md-12">
                    <p class="mb-2">
                        ㈜스마트인잡(명칭 ‘이사청소한방’)과의 거래와 관련하여 ㈜스마트인잡(명칭 ‘이사청소한방’)이 본인의 개인정보를 수집·이용 하고자 하는 경우 [개인정보 보호법]제15조 및 제22조, 제24조, [신용정보의 이용 및 보호에 관한 법률]제32조, 제33조 및 제34조에 따라 동의를 얻어야 합니다. 이에 본인은 ㈜스마트인잡(명칭 ‘이사청소한방’)이 아래의 내용과 같이 본인의 개인정보를 수집·이용 하는데 동의합니다.
                    </p>
                    ...
                    <p><i class="fa fa-check"></i>
                        ㈜스마트인잡(명칭 ‘이사청소한방’) 이벤트·행사 안내, 상품 안내 및 이용 권유를 위한 수집 및 이용
                        가. 개인(신용)정보의 수집.이용 목적 : ㈜스마트인잡(명칭 ‘이사청소한방’)의 행사안내(할인, 이벤트 등), 귀사 및 제휴사 상품·서비스 안내 및 이용권유, 시장조사 및 상품·서비스 연구개발
                        나. 수집.이용할 개인(신용)정보의 내용 : 필수적 수집.이용에 동의한 개인(신용)정보(고유식별정보 제외)
                        다. 개인(신용)정보의 보유 및 이용기간 : 계약 종료 또는 회원 탈퇴 시까지
                    </p>
                    <p><i class="fa fa-check"></i>
                        ㈜스마트인잡(명칭 ‘청소매니아’) 상품 이외의 부수서비스 안내 등을 위한 수집·이용
                        가. 개인(신용)정보의 수집.이용 목적
                        - ㈜스마트인잡(명칭 ‘청소매니아’)의 부수업무와 관련한 마케팅 활동
